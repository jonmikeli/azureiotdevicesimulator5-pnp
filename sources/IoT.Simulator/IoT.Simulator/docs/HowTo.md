...
Also, the arrival of .NET 5 brings interesting capabilities to build reduced and selfsuficient application packages (ex: selcontained or trim build options).
